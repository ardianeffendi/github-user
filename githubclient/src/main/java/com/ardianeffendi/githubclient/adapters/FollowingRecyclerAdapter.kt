...
import com.ardianeffendi.githubclient.models.FollowingResponseItem
import com.ardianeffendi.githubclient.models.UsersItem
...
class FollowingRecyclerAdapter : RecyclerView.Adapter<FollowingRecyclerAdapter.ListViewHolder>() {
    ...
    private var onItemClickListener: ((FollowingResponseItem) -> Unit)? = null
